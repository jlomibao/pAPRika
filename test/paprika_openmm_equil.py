...
for window in window_list:
    ...
    if os.path.exists(path+window+settings["traj_file"]):
        break
    ...
    guest_angle_g1 = rest.phase[phase]["targets"][window_num]
    angle_fc = rest.phase[phase]["force_constants"][window_num]
    theta0 = guest_angle_g1 * unit.degrees
    k = angle_fc * unit.kilocalories_per_mole / unit.radians**2
    ...
    guest_restraints.append(angle_restraint_g1)
    ...
    guest_angle_g2 = rest.phase[phase]["targets"][window_num]
    angle_fc = rest.phase[phase]["force_constants"][window_num]
    theta0 = guest_angle_g2 * unit.degrees
    k = angle_fc * unit.kilocalories_per_mole / unit.radians**2
    ...
    guest_restraints.append(angle_restraint_g2)
